      ...
      <Accordion type="multiple" collapsible className="w-full md:px-11">
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            ...
            of that URL. This shortened URL redirect to the original long URL
            when accessed
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-2">
          ...
          <AccordionContent>
            Yes, Creating an account allows your to manage your URLs, view
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            You can view the number clicks, geolocation data of the clicks and
